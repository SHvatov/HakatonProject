...
public class Controller {
    ...
    void addphoto(ActionEvent event) throws Exception{
        ...
        FXMLLoader fxmlLoader = new
                FXMLLoader(getClass().getResource("HakatonProject/resources/interface/fxml/addphoto.fxml"));
    ...
    void askHelp(ActionEvent event) throws Exception {
        ...
        stage.close();
        FXMLLoader fxmlLoader = new
                FXMLLoader(getClass().getResource("HakatonProject/resources/interface/fxml/instruction.fxml"));
        Parent root = fxmlLoader.load();
        Stage stage1 = new Stage();
        stage1.setOpacity(1);
